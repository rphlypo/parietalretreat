...
def run(root_dir="/", dump_dir=None, data_set=None, n_jobs=1, maps_img=None):
...
if __name__ == "__main__":
    run(root_dir="/media/Elements/workspace/brainpedia/preproc/",
        data_set="ds105",
        dump_dir="/media/Elements/workspace/" +
        "parietal_retreat/salma",
        n_jobs=1)